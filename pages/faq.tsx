...
const questions = [
  ...
  },
  {
    ...
    answer:
      'Yes, if there is a total amount limit of US$10,000 for the NFT sale, thus there will also be a limit on the number of NFTs you can purchase. The specific quantity will depend on the latest price of the auction and the total quantity of NFTs still available for the sale.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, after purchasing an NFT through the Dutch auction you\'ll be able to sell it to other users on the secondary market.',
  },
  {
