          ...
          <Container>
            <Box mb={8}>
              ...
              <Stack color="gray.300" fontSize="sm" px={[0,0,6]} spacing={2}>
                ...
                <Text>
                  ...
                  Unless expressly agreed otherwise or unless a different contractual classification is required by mandatory law, FP shall
                  provide all its services to the User as services.
                </Text>
            ...
            <Box mt={8} mb={8}>
              ...
              <Stack color="gray.300" fontSize="sm" px={[0,0,6]} spacing={4}>
                ...
                <Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Date and time of access</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>IP address</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Host name of the accessing computer</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Website from which the website was accessed</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Websites accessed via the website</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Page visited on our website</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Message whether the retrieval was successful</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Transmitted data volume</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Information about the browser type and version used</Text>
                    <Text>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Operating system</Text>
                </Text>
                <Text>
