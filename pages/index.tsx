  ...
  return (
    <div>
      ...
      <main className="w-full min-h-screen">
        <img
          className="fixed -z-20 min-w-full min-h-full max-w-none max-h-none top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
          src={bg}
        ></img>

        <div className="w-full h-full bg-black/60 -z-10 fixed"></div>
        ...
        <div className="min-h-screen flex flex-col md:px-[10%] lg:px-[15%] 2xl:px-[20%] 4xl:px-[25%]">
          ...
          <div className="flex-grow p-8 md:px-0 flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-8 mt-24">
              ...
              <h2 className="font-aktiv-light text-2xl">Coming soon — a collection about velocity and perception.</h2>
            </div>

            {/* 2nd item */}
            <div className="flex flex-col md:flex-row gap-4 md:items-center mb-12">
              <h2 className="font-aktiv-light text-lg md:text-xl">By Harm van den Dorpel, in partnership with Mercedes-Benz and Fingerprints DAO.</h2>
