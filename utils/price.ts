...
export const roundEtherUp = (n?: BN) => normalizeBigNumber(n).toFormat(NumberSettings.Decimals, BigNumber.ROUND_UP)

export const roundEtherFloor = (n?: BN) => normalizeBigNumber(n).toFormat(NumberSettings.Decimals, BigNumber.ROUND_FLOOR)
